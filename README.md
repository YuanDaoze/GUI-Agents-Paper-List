...
- [title](paper link)
    ...
    - 🏛️ Institutions: Institution1, Institution2, etc.
    - 📅 Date: Oct 30, 2024
    - 📑 Publisher: ICLR 2025
    - 💻 Env: [environment, e.g., Web, Mobile]
    - 🔑 Key: [key1], [key2], [key3], etc.
    - 📖 TLDR: Brief summary of the paper.

You can simply leave the paper name or the full formatted results in an issue.
