...
- [OSWorld: Benchmarking Multimodal Agents for Open-Ended Tasks in Real Computer Environments](https://arxiv.org/abs/2404.07972)
    ...
    - 💻 Env: [GUI]
    - 🔑 Key: [benchmark], [dataset], [GUI grounding], [multimodal agents], [real computer tasks]
...
- [Search Beyond Queries: Training Smaller Language Models for Web Interactions via Reinforcement Learning](https://arxiv.org/abs/2404.10887)
    ...
    - 📑 Publisher: arXiv
    - 💻 Env: [Web]
    - 🔑 Key: [framework], [reinforcement learning], [grounded language agent], [web navigation], [Flan-T5], [unsupervised domain adaptation]
...
- [On the Effects of Data Scale on Computer Control Agents](https://arxiv.org/abs/2406.03679)
    ...
    - 📑 Publisher: NeurIPS 2024
    - 💻 Env: [Mobile]
    - 🔑 Key: [model], [dataset], [benchmark], [AndroidControl]
    - 📖 TLDR: This paper investigates how the size of training data influences the performance of computer control agents, specifically examining in-domain and out-of-domain results. It introduces the AndroidControl dataset, comprising 15,283 unique tasks involving 833 Android apps, which allows for analysis of model performance. The study finds that while more data can improve performance in-domain, the increase in out-of-domain performance is less pronounced, particularly for high-level tasks, suggesting that merely increasing data is insufficient for robust generalization.
...
- [Ferret-UI: Grounded Mobile UI Understanding with Multimodal LLMs](https://arxiv.org/abs/2404.05719)
    ...
    - 📑 Publisher: ECCV 2024
    - 💻 Env: [Mobile]
    - 🔑 Key: [framework], [dataset], [multimodal interaction], [UI understanding], [reasoning]
    - 📖 TLDR: This paper presents Ferret-UI, a multimodal large language model designed specifically for understanding and interacting with mobile user interfaces. It incorporates advanced capabilities for referring, grounding, and reasoning about UI components. Ferret-UI enhances interaction by employing an "any resolution" approach to accurately process mobile screens, which are characterized by elongated aspect ratios and small UI elements. The authors constructed a comprehensive dataset for training that includes a wide range of UI tasks, demonstrating that Ferret-UI outperforms existing models, including GPT-4V, in various UI comprehension tasks.
